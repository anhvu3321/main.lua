...
getgenv().Auto_Buy_Exp = false
getgenv().Auto_Buy_200_Fracment = false
getgenv().Auto_Buy_500_Fracment = false
getgenv().Auto_Collect_Gift = false
...
getgenv().Settings = {
    ...
    ["Auto Buy Exp"] = getgenv().Auto_Buy_Exp,
    ["Auto Buy 200 Fracment"] = getgenv().Auto_Buy_200_Fracment,
    ["Auto Buy 500 Fracment"] = getgenv().Auto_Buy_500_Fracment,
    ["Auto Collect Gift"] = getgenv().Auto_Collect_Gift,
...
local function LoadSettings()
    if isfile("Xero Hub/Settings.json") then
        ...
        getgenv().Auto_Buy_Exp = getgenv().Settings["Auto Buy Exp"] or false
        getgenv().Auto_Buy_200_Fracment = getgenv().Settings["Auto Buy 200 Fracment"] or false
        getgenv().Auto_Buy_500_Fracment = getgenv().Settings["Auto Buy 500 Fracment"] or false
        getgenv().Auto_Collect_Gift = getgenv().Settings["Auto Collect Gift"] or false
...
local function tween(place, item, boss, state, fruit)
    repeat task.wait()
        ...
        if state ~= nil then
            ...
            elseif state == "Auto Collect Gift" then
                if not getgenv().Auto_Collect_Gift then
                    StopTween()
                    break
                end
...
local function AutoFarmBoss(boss)
    pcall(function()
        ...
        tween(CFrameBoss * CFrame.new(0, 30, 0), nil, boss, "Auto Farm Boss")
        if queue:empty() or queue:top() ~= "Auto Farm Boss" then
            StopTween()
            return
        end
    ...
    if not queue:empty() and queue:top() == "Auto Farm Kata" and getgenv().Weapon ~= nil then
        pcall(function()
            ...
            if CFrameBoss ~= nil then
                ...
                tween(CFrameBoss * CFrame.new(0, 30, 0), nil, NameBoss, "Auto Farm Kata")
                if queue:empty() or queue:top() ~= "Auto Farm Kata" then
                    StopTween()
                    return
                end
                    ...
                    for _, boss in pairs(game:GetService("Workspace").Enemies:GetChildren()) do
                        ...
                        if boss.Name == NameBoss and boss:FindFirstChild("Humanoid") and boss:FindFirstChild("Humanoid").Health > 0 and game:GetService("Players").LocalPlayer.Character:FindFirstChild("Humanoid").Health > 0 then
                            repeat task.wait(Fast_Attack_Delay)
                                ...
                                UpdateWeapon()
                                tween(boss:FindFirstChild("HumanoidRootPart").CFrame*CFrame.new(0, 30, 0), nil, nil, "Auto Farm Kata")
                                AddVelocity()
                                EquipWeapon(getgenv().Weapon)
                                AttackNoCD()
                            until boss:FindFirstChild("Humanoid").Health <= 0
...
local function BuyExp()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 1, 1)
end
local function Buy200Fracment()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 2, 1)
end
local function Buy500Fracment()
    game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 2, 2)
end
local function GetCountDownTime()
    if game:GetService("Workspace").Countdown.SurfaceGui.TextLabel.Text:find("START") ~= nil then
        return nil
    end
    if tonumber(game:GetService("Workspace").Countdown.SurfaceGui.TextLabel.Text:split(":")[1]) == 0 then
        return tonumber(game:GetService("Workspace").Countdown.SurfaceGui.TextLabel.Text:split(":")[2])
    end
    return nil
end
local function AutoCollectGift()
    pcall(function()
        if (game:GetService("Workspace").PresentPad.CFrame.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).Magnitude > 60 then
            tween(game:GetService("Workspace").PresentPad.CFrame, nil, nil, "Auto Collect Gift")
        end
        if GetCountDownTime() ~= nil then
            repeat task.wait(1)
                if queue:empty() or queue:top() ~= "Auto Collect Gift" then
                    StopTween()
                    return
                end
                if (game:GetService("Workspace").PresentPad.CFrame.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).Magnitude > 60 then
        ...
        for i, v in pairs(game:GetService("Workspace"):GetDescendants()) do
            ...
            if v:IsA("ProximityPrompt") and (v.Parent.Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).Magnitude <= 500 then
                game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart").CFrame = v.Parent.CFrame
                task.wait(0.1)
...
Main:AddLabel("V2.0.3")
Main:AddParagraph("Paragraph","Paragraph Content")
Main:AddTextbox({
...
Gift_Count_Down = Event:AddLabel("0:00:00")
Event:AddToggle({
    Name = "Auto Collect Gift",
	Default = getgenv().Auto_Collect_Gift,
	Callback = function(Value)
        StopTween()
		getgenv().Auto_Collect_Gift = Value
  	end
})
Event:AddButton({
    Name = "Teleport To Present Position",
    Callback = function()
        StopTween()
        tween(game:GetService("Workspace").PresentPad.CFrame)
    end
})
Event:AddButton({
    Name = "Buy Sleigh (1,000 candies)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 3, 3)
    end
})
Event:AddButton({
    Name = "Buy Santa Hat (500 candies)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 3, 2)
    end
})
Event:AddButton({
    Name = "Buy Elf Hat (250 candies)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 3, 1)
    end
})
Event:AddButton({
    Name = "Buy Race Reroll (100 candies)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 1, 3)
    end
})
Event:AddButton({
    Name = "Buy Stat Refund (75 candies)",
    Callback = function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("Candies", "Buy", 1, 2)
    end
})
Event:AddToggle({
    Name = "Auto Buy 15 min x2 Exp (50 candies)",
	Default = getgenv().Auto_Buy_Exp,
	Callback = function(Value)
		getgenv().Auto_Buy_Exp = Value
  	end
})
Event:AddToggle({
    Name = "Auto Buy 200 Fracments (50 candies)",
	Default = getgenv().Auto_Buy_200_Fracment,
	Callback = function(Value)
		getgenv().Auto_Buy_200_Fracment = Value
  	end
})
Event:AddToggle({
    Name = "Auto Buy 500 Fracments (100 candies)",
	Default = getgenv().Auto_Buy_500_Fracment,
	Callback = function(Value)
		getgenv().Auto_Buy_500_Fracment = Value
  	end
})
-- Auto Farm
...
AutoFarm:AddToggle({
    Name = "Safe Auto Farm Level (Only work with English language)",
...
spawn(function()
    while task.wait(0.01) do
        pcall(function()
            Gift_Count_Down:Set(game:GetService("Workspace").Countdown.SurfaceGui.TextLabel.Text)
            AddStats()
            SafeAutoFarmLevel()
            if W3 then
                UpdateMobKataKilled()
            end
            if getgenv().Auto_Buy_Exp then
                BuyExp()
            end
            if getgenv().Auto_Buy_200_Fracment then
                Buy200Fracment()
            end
            if getgenv().Auto_Buy_500_Fracment then
                Buy500Fracment()
            end
...
spawn(function()
    while task.wait(0.01) do
        ...
        if getgenv().Auto_Collect_Gift then
            local Time = GetCountDownTime()
            if Time ~= nil then
                if Time <= 2 then
                    if not Check_Gift then
                        StopTween()
                        Check_Gift = true
                    end
                    queue:push("Auto Collect Gift", Priority["Auto Collect Gift"])
                elseif Time > 2 then
                    queue:pop("Auto Collect Gift")
                    Check_Gift = false
                end
            end
        elseif not getgenv().Auto_Collect_Gift then
            queue:pop("Auto Collect Gift")
            Check_Gift = false
        end
        if getgenv().Auto_Raid then
            ...
            elseif getgenv().Dungeon ~= nil then
                if game:GetService("Players").LocalPlayer.PlayerGui.Main.Timer.Visible == false and (not game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") or (game:GetService("Workspace")["_WorldOrigin"].Locations["Island 5"].Position - game:GetService("Players").LocalPlayer.Character:FindFirstChild("HumanoidRootPart").Position).Magnitude > 5000) then
                    local fruit = GetLowestValueFruit()
                    if fruit == nil then
                    ...
                    elseif fruit ~= nil then
                        if not Check_Raid then
                            StopTween()
                            Check_Raid = true
                        end
    ...
    while task.wait() do
        if not queue:empty() then
            ...
            elseif queue:top() == "Auto Farm Kata" then
                AutoFarmKata()
            elseif queue:top() == "Auto Collect Gift" then
                AutoCollectGift()
