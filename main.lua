...
getgenv().Auto_Buy_Exp_Winter_Event = false
getgenv().Auto_Buy_200_Fracment_Winter_Event = false
getgenv().Auto_Buy_500_Fracment_Winter_Event = false
...
getgenv().Settings = {
    ...
    ["Auto Buy Exp Winter Event"] = getgenv().Auto_Buy_Exp_Winter_Event,
    ["Auto Buy 200 Fracment Winter Event"] = getgenv().Auto_Buy_200_Fracment_Winter_Event,
    ["Auto Buy 500 Fracment Winter Event"] = getgenv().Auto_Buy_500_Fracment_Winter_Event
}
...
local function LoadSettings()
    if isfile("Xero Hub/Settings.json") then
        ...
        getgenv().Auto_Buy_Exp_Winter_Event = getgenv().Settings["Auto Buy Exp Winter Event"] or false
        getgenv().Auto_Buy_200_Fracment_Winter_Event = getgenv().Settings["Auto Buy 200 Fracment Winter Event"] or false
        getgenv().Auto_Buy_500_Fracment_Winter_Event = getgenv().Settings["Auto Buy 500 Fracment Winter Event"] or false
    end
end
LoadSettings()
spawn(function()
...
Event:AddToggle({
	...
	Default = getgenv().Auto_Buy_Exp_Winter_Event,
	Callback = function(Value)
		getgenv().Auto_Buy_Exp_Winter_Event = Value
  	end
})
Event:AddToggle({
    Name = "Auto Buy 200 Fracments (50 candies)",
	Default = getgenv().Auto_Buy_200_Fracment_Winter_Event,
	Callback = function(Value)
		getgenv().Auto_Buy_200_Fracment_Winter_Event = Value
  	end
})
Event:AddToggle({
    Name = "Auto Buy 500 Fracments (100 candies)",
	Default = getgenv().Auto_Buy_500_Fracment_Winter_Event,
	Callback = function(Value)
		getgenv().Auto_Buy_500_Fracment_Winter_Event = Value
  	end
})
-- Auto Farm
...
spawn(function()
    while task.wait(0.01) do
        ...
        if getgenv().Auto_Buy_Exp_Winter_Event then
            BuyExpWinterEvent()
        end
        if getgenv().Auto_Buy_200_Fracment_Winter_Event then
            Buy200FracmentWinterEvent()
        end
        if getgenv().Auto_Buy_500_Fracment_Winter_Event then
            Buy500FracmentWinterEvent()
        end
